...
### 🚀 Samouki Developer & CyberSec Entuzijasta
Strastveni programer sa fokusom na automatizaciju, mrežnu bezbednost i primenu veštačke inteligencije (AI) u rešavanju realnih poslovnih problema.

---

### 👨‍💻 Moja Priča (Od Commodore-a do AI-ja)
Moje putovanje kroz tehnologiju počelo je u 4. godini uz kineske klonove Commodore 64 konzola. Već sa 5 godina samostalno sam rešavao softverske probleme na svom prvom Pentium računaru, učeći kroz eksperiment i stare IT časopise. 

Iako me je život privremeno odveo u druge industrije radi egzistencije, programiranju sam se vratio sa istim intenzitetom (učeći i po 16 sati dnevno). Danas uspešno spajam svoje bazično znanje iz sajber bezbednosti i administracije sa modernim AI alatima (Vibe Coding) i razvojem praktičnih aplikacija.

---

### 🛠️ Tehnologije i Alati
* **Jezici**: Python, JavaScript, Bash (Shell Skripte), C++, HTML5, CSS3
* **Mreže i Administracija**: CCNA (Mrežni protokoli i konfiguracija), Linux & Windows Server administracija
* **Specijalnosti**: OSINT, Forenzika, OWASP metodologije, Automatizacija procesa

---

### 💡 Trenutni Projekti u Razvoju
1. **AI Business Assistant**: Privatni program zasnovan na veštačkoj inteligenciji koji automatizuje svakodnevne zadatke.
2. **SaaS za Male Preduzetnike**: Web/Mobile aplikacija namenjena lokalnim biznisima (frizerski saloni, servisi, prodavnice) koja im pomaže da digitalizuju vođenje inventara, zakazivanje i komunikaciju sa kupcima. *Projektovano sa fokusom na CyberSec bezbednost podataka korisnika.*

---

### 📈 Istaknuti Repozitorijumi
* 📁 **[CCNA_Kurs](./CCNA_Kurs)** - Moje beleške, labovi i priprema za CCNA ispite. Dokaz razumevanja mrežne arhitekture.
* 📁 **[Auto-mod-turn-Tp-link](./Auto-mod-turn-Tp-link-)** - Praktična Bash skripta za automatizaciju prebacivanja mrežnih kartica u monitor mod.
* 📁 **[Activation-Scripts](./Activation-Scripts)** - Automatizacija i administracija unutar Windows okruženja kroz Batch fajlove.

---

### 📬 Kontakt i Saradnja
Otvoren sam za pozicije **Junior Python/Web Developera**, **Junior DevOps** ili prakse u oblasti **Cyber Security-ja**.
* 📍 Lokacija: Niš, Srbija / Rad na daljinu (Remote)
